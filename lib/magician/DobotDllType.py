...
def load():
    ...
    if platform.system() == "Windows":
        ...
        return CDLL(os.path.join(script_dir, "DobotDll.dll"),  RTLD_GLOBAL)
    elif platform.system() == "Darwin":
        return CDLL(os.path.join(script_dir, "libDobotDll.dylib"),  RTLD_GLOBAL)
    elif platform.system() == "Linux":
        return cdll.loadLibrary(os.path.join(script_dir, "libDobotDll.so"))
